...
/**
 *@title MYSv2 Token Contract
 *@file mystaketest.sol
 *
 */

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//      _____ ______       ___    ___ ________  _________  ___  ________  ________  ________  ________          //
//     |\   _ \  _   \    |\  \  /  /|\   ____\|\___   ___\\  \|\   ____\|\   ___ \|\   __  \|\   __  \         //  
//     \ \  \\\__\ \  \   \ \  \/  / | \  \___|\|___ \  \_\ \  \ \  \___|\ \  \_|\ \ \  \|\  \ \  \|\  \        //
//      \ \  \\|__| \  \   \ \    / / \ \_____  \   \ \  \ \ \  \ \  \    \ \  \ \\ \ \   __  \ \  \\\  \       //  
//       \ \  \    \ \  \   \/  /  /   \|____|\  \   \ \  \ \ \  \ \  \____\ \  \_\\ \ \  \ \  \ \  \\\  \      //
...
contract MYSv2test is MintableToken, HasNoEther 
{
    // Using libraries 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////                                                                
    ...
    */
    ...
    string public constant name = "Mystic DAO V2 test";
    string public constant symbol = "MYSv2test";
    uint8 public constant  decimals = 18;
/**
 *    ________  _________  ________  ___  __    ___  ________   ________     
 *  |\   ____\|\___   ___\\   __  \|\  \|\  \ |\  \|\   ___  \|\   ____\    
 *  \ \  \___|\|___ \  \_\ \  \|\  \ \  \/  /|\ \  \ \  \\ \  \ \  \___|    
 *   \ \_____  \   \ \  \ \ \   __  \ \   ___  \ \  \ \  \\ \  \ \  \  ___  
 *    \|____|\  \   \ \  \ \ \  \ \  \ \  \\ \  \ \  \ \  \\ \  \ \  \|\  \ 
 *      ____\_\  \   \ \__\ \ \__\ \__\ \__\\ \__\ \__\ \__\\ \__\ \_______\
 *     |\_________\   \|__|  \|__|\|__|\|__| \|__|\|__|\|__| \|__|\|_______|
 *     \|_________|                                                         
 *                
 *  ________ ___  ___  ________   ________ _________  ___  ________  ________   ________  ___       ___  _________    ___    ___ 
 * |\  _____\\  \|\  \|\   ___  \|\   ____\\___   ___\\  \|\   __  \|\   ___  \|\   __  \|\  \     |\  \|\___   ___\ |\  \  /  /|
 * \ \  \__/\ \  \\\  \ \  \\ \  \ \  \___\|___ \  \_\ \  \ \  \|\  \ \  \\ \  \ \  \|\  \ \  \    \ \  \|___ \  \_| \ \  \/  / /
 *  \ \   __\\ \  \\\  \ \  \\ \  \ \  \       \ \  \ \ \  \ \  \\\  \ \  \\ \  \ \   __  \ \  \    \ \  \   \ \  \   \ \    / / 
 *   \ \  \_| \ \  \\\  \ \  \\ \  \ \  \____   \ \  \ \ \  \ \  \\\  \ \  \\ \  \ \  \ \  \ \  \____\ \  \   \ \  \   \/  /  /  
 *    \ \__\   \ \_______\ \__\\ \__\ \_______\  \ \__\ \ \__\ \_______\ \__\\ \__\ \__\ \__\ \_______\ \__\   \ \__\__/  / /    
 *     \|__|    \|_______|\|__| \|__|\|_______|   \|__|  \|__|\|_______|\|__| \|__|\|__|\|__|\|_______|\|__|    \|__|\___/ /     
 *                                                                                                                  \|___|/      
 * @title How To Stake MYS
 * 
 * @section tutorial
 *
 * Head on Contract Tab
 * Then click Write
 * Click on connect to web3
 * Head down to stakeMYS function
 * Write the amount you wanna stake with 18 zeros
 * Lastly Click Write and then Confirm
 *
 */
    ...
    /// @dev MYS token constructor
    function MYS2() public
    {
        // Define owner
        owner = msg.sender;
        // Define initial owner supply. (ether here is used only to get the decimals right)
        uint _initOwnerSupply = 300000 ether;
        ...
        // 8,000 minted tokens per day, 86,400 seconds in a day
        ownerMintRate = calculateFraction(8000, 86400, decimals);
        
        // 3,000,000 targeted minted tokens per year via staking; 31,536,000 seconds per year
        globalMintRate = calculateFraction(3000000, 31536000, decimals);
    }

    /// @dev staking function which allows users to stake an amount of tokens to gain interest for up to 10 days 
    function stakeMYS(uint _stakeAmount) external
    {
    ...
    function stakeMYSSplit(uint _stakeAmount, address _stakeSplitAddress) external
    {
        // Require that a MYS split actually be split with an address
    ...
    function claimStake() external returns (bool success)
    {
        ...
        // Subtract stake balance from totalMYSStaked
        totalMYSStaked -= stakeBalances[msg.sender].initialStakeBalance;
    ...
    function stakeTokens(uint256 _value) private returns (bool success)
    {
        ...
        totalMYSStaked += _value;

        /// Determine percentage of global stake
        stakeBalances[msg.sender].initialStakePercentage = calculateFraction(_value, totalMYSStaked, decimals);
    ...
    function calculateStakeGains(uint _timePassedSinceStake) view private returns (uint mintTotal)
    {
        ...
        uint _finalMintRate;            // store our calculated final mint rate (in MYS-per-second)
        ...
        if (_timePassedSinceStake > _secondsPerDay) {
            ...
            // First, calculate our final stake percentage based upon the total amount of MYS staked
            _finalStakePercentage = calculateFraction(stakeBalances[msg.sender].initialStakeBalance, totalMYSStaked, decimals);
            ...
            // Finally, calculate our final mint rate (in MYS-per-second)
